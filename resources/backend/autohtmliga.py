...
<html lang="en">
	...
	out+="		<div class=\"align\">\n"
	if k!=0:
		out+="			<a href=\"shop_iga" + str(k) + ".html\"><button>&larr;</button></a>\n"
	out+="			Page: " + str(k+1) + "\n"
	if k!=4:
		out+="			<a href=\"shop_iga" + str(k+2) + ".html\"><button>&rarr;</button></a>\n"
	out+="		</div>\n"
	out+="	</body>\n"
	out+="</html>"
	with open("igahtml/shop_iga" + str(k+1) + ".html", "w") as data:
		data.write(out)
